...
### Step 1: Login to VM.
1. Enter the VM password: ######## <!--Password -->.
2. Click **Submit** or **Press Enter** to access the VM.

<!-- 
### Step 2: Open Microsoft Edge Browser
1. Once logged into the VM, locate the **Microsoft Edge** browser icon on the desktop or in the start menu.
2. Open **Microsoft Edge**.
3. In the address bar, enter: [https://portal.azure.com](https://portal.azure.com)
4. Press **Enter** to launch the Azure portal.


### Step 3: Login to Azure Portal
1. In the Azure Portal login page, enter your Azure username: Username.
2. Enter your Azure password: Password.
3. Click **Sign in** to access the Azure Portal dashboard.

### Step 4: Check Fabric Capacity Availability (Optional)
1. In the Azure Portal, navigate to the **All Resources** section.
   - You can find it in the left-hand sidebar or by using the search bar at the top.
    <img src=images/ik0wyi3b.jpg />
    <img src=ecdfdudg.jpg](images/ecdfdudg.jpg />
2. In the **All Resources** view, locate your Fabric Capacity resources.

    <img src=images/6ljsvo72.jpg />

   - You may need to use filters or the search feature to find specific resources.
    <img src=images/v8ly2pp2.jpg />
3. Verify the availability of your Fabric Capacity resources.
   - Ensure they are in a healthy state and have the necessary configurations for your lab activities.
   <img src=fmstefqr.jpg](images/fmstefqr.jpg /> 

   Alternatively, Click **Workspaces** in the left navigation menu and **+ New workspace** to create a new workspace.

    <img src=images/4hv16x2z.jpg />
-->
...
3. In the sign up page, enter the Email : **Username** and click **Submit**.
...
9. Click on **User Profile** in the top right corner, then select **Free trial** from the user profile menu, and finally click **Activate** in the popup window.

    <img src=images/b0pim1p1.jpg />

10. Click **Got it** in the next popup window. 

    <img src=images/b8uwt4h1.jpg />
...
3. Enter the **workspace** **ws-models2outcomes-##** and click/expand **Advanced** to assign the license mode for Fabric workload.
...
5. Optionally, you may select a Semantic model storage format as **Large Semantic model storage format**. 
